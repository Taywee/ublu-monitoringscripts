...
echo "Usage: $0 [silent] [-h] [-X...] [-Dprop=val] -p PROPERTIES [-q MSGQUEUE] -t TIMEFILE -P PATTERN"
echo "	where"
...
# Invocation
java${JVMOPTS}${JVMPROPS} -Dublu.includepath="$SCRIPTDIR" -jar /opt/ublu/ublu.jar ${gensh_runtime_opts} include ${SILENT}sysshep/msgq.ublu sysshep.msg_matches \( @properties @msgqueue @timefile @pattern \) 
exit $?
