...
# autogenerated Wed Dec 14 13:37:37 MST 2016 by taylor using command:
# gensh -to sysshep.nodiskstat.sh -path /opt/ublu/ublu.jar -optr p PROPERTIES @properties ${ credentials properties file }$ ${ sysshep.nodiskstat.sh: do monitoring when diskstat is not available, through db2 }$ sysshep.nodiskstat.ublu ${ sysshep.nodiskstat ( @properties ) }$

# Usage message
function usage { 
echo "sysshep.nodiskstat.sh: do monitoring when diskstat is not available, through db2 "
echo "This shell script was autogenerated Wed Dec 14 13:37:37 MST 2016 by taylor."
